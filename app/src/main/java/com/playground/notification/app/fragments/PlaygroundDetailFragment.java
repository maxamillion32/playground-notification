...
public final class PlaygroundDetailFragment extends DialogFragment {
	...
	public static class EventHandler {
		...
		public void onGoClicked( View v ) {
			mBinding.goBtn.getContext().startActivity( com.playground.notification.utils.Utils.getMapWeb( new LatLng( mLat, mLng ),
																										  new LatLng( mGround.getLatitude(),
																													  mGround.getLongitude()
																										  )
			) );
		}
